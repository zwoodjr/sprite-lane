(() => {
  ...
  // --- Sparkfist (Hero Crest) — gauntlets + ember burst ---
  ...
  // --- Hoverbind (Hero Crest) — float gloves + blue aura ---
  ...
  // quirling — Hero Crest energy minion
  ...
  const blastcrown = tintPack(sparkfist, "#ff8a60", "#ffe08a", 0.3, 0.35);

  const hoverbind = {
    idle: [hoverIdle0, hoverIdle1],
    attack: [hoverAtk0, hoverAtk1],
  };
  const zerofield = tintPack(hoverbind, "#5a8fd4", "#9ad0ff", 0.32, 0.36);
