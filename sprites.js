(() => {
  ...
  // --- Sparkfist / Dark Deku — shop-card matched full body ---
  // Vigilante: near-black green hair, shadowed freckled face, tattered dark
  // suit, lime smash gauntlets — full legs like other anime units.
