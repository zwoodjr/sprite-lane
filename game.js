(() => {
  ...
  // --- Unit definitions (original names + archetype notes for designers) ---
  const UNITS = [
    {
      id: "palewall",
      name: "Palewall",
  ...
  const SERIES_FLAVOR = {
    "Hero Crest": "Ember gauntlets and float gloves — Hero Crest originals",
    "Breath Line": "Water cleave and lightning blink — Breath Line originals",
    "Wall Corps": "Stone smash and wire stabs — Wall Corps originals",
    "Curse Ward": "Crimson fists and spirit marks — Curse Ward originals",
    "Gate Shade": "Shadow knives and ash tendrils — Gate Shade originals",
    "Lane Works": "Cheap crates to snake the lane — Lane Works originals",
  };
